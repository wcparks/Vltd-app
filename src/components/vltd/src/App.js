  ...
  if (view === "ticket" && activeTicket) return (
    <div style={S.app}>
      ...
      <div style={S.content}>
        ...
        {valetRole === "manager" && (
          <button style={S.btnRed} onClick={() => deleteTicket(activeTicket.id)}>🗑️ DELETE TICKET</button>
        )}
    ...
    return (
      <div style={S.app}>
        <div style={S.header}>
          ...
          <button style={S.btnOutline} onClick={() => { setView("dashboard"); setSubView(null); }}><- Back</button>
        </div>
        <div style={S.content}>
          {/* Manager quick-nav */}
